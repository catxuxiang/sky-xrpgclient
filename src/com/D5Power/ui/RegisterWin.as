package com.D5Power.ui
{
	...
	public class RegisterWin extends BaseWin
	{
		...
		override protected function build():void
		{
			...
			tf = new D5TLFText("Register, please enter the desire name and password:",0xffffff);
			tf.fontBorder = 0;
			...
			_btn = new D5IVfaceButton(Global.resPool.getResource('ui_btn1'),register);
			_btn.lable = 'Register';
			_btn.id=0;
			
			var _btn1:D5IVfaceButton = new D5IVfaceButton(Global.resPool.getResource('ui_btn1'),cancel);
			_btn1.lable = 'Cancel';
			_btn1.id=1;			
			
			uname = new D5TLFText("",0xffffff);
		...
		private function cancel(id:uint):void
		{
			this.close();
			Main.my.logIn();		
		}
